...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
    ...
    <link href='${createLinkTo(dir: 'css', file: 'googleFontCuprum.css')}' rel='stylesheet' type='text/css' />
    ...
    <script type="text/javascript" src="${createLinkTo(dir: 'js', file: 'jquery-1.9.1.min.js')}"></script>
