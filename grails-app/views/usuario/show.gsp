            ...
            <fieldset>
                <div class="widget first">
                    ...
                    <g:if test="${usuarioInstance?.nome}">
                        <div class="rowElem"><label><span id="nome-label" class="property-label"><g:message code="usuario.nome.label" default="Nome" /></span>:</label>
                            <div class="formRight">
                                
                                <span class="property-value" aria-labelledby="nome-label"><g:textField readonly="readonly" name="${usuarioInstance}" value="${usuarioInstance.nome}" /></span>
                    ...
                    <g:if test="${usuarioInstance?.email}">
                        <div class="rowElem"><label><span id="email-label" class="property-label"><g:message code="usuario.email.label" default="Email" /></span>:</label>
                            <div class="formRight">
                                
                                <span class="property-value" aria-labelledby="email-label"><g:textField readonly="readonly" name="${usuarioInstance}" value="${usuarioInstance.email}" /></span>
                                
                            </div><div class="fix"></div></div>
                    </g:if>
                    
                    <g:if test="${usuarioInstance?.perfil}">
                        <div class="rowElem"><label><span id="perfil-label" class="property-label"><g:message code="usuario.perfil.label" default="Perfil" /></span>:</label>
                            <div class="formRight">
                                
                                <span class="property-value" aria-labelledby="perfil-label"><g:link controller="perfil" action="show" id="${usuarioInstance?.perfil?.id}">${usuarioInstance?.perfil?.encodeAsHTML()}</g:link></span>
